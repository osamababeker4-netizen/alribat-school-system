...
document.documentElement.style.setProperty("--ribat-original-logo",`url("${ORIGINAL_LOGO_DATA}")`);
let appIcon=document.querySelector('link[rel="icon"]');if(!appIcon){appIcon=document.createElement("link");appIcon.rel="icon";document.head.appendChild(appIcon)}appIcon.href=ORIGINAL_LOGO_DATA;appIcon.type="image/png";
