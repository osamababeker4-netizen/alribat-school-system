...
export const blank={version:2,school:{name:"مدرسة الرباط",fullName:"مدرسة الرباط الأساسية المختلطة الخاصة",currency:"جنيه سوداني",academicYear:"2026/2027",phone:"",email:"",address:"PORT SUDAN",logoUrl:"./alribat-seal.svg",subjects:["اللغة العربية","اللغة الإنجليزية","الرياضيات","العلوم","الدراسات الإسلامية","الدراسات الاجتماعية"],gradeScale:[{min:85,label:"ممتاز"},{min:75,label:"جيد جداً"},{min:65,label:"جيد"},{min:50,label:"مقبول"},{min:0,label:"راسب"}]},students:[],fees:[],payments:[],expenses:[],staff:[],staffAttendance:[],attendance:[],inventory:[],moves:[],requests:[],grades:[],users:[{id:"u-admin",name:"مدير النظام",email:"admin@alribat.local",phone:"",role:"مدير النظام",active:true}],audit:[],notifications:[]};
